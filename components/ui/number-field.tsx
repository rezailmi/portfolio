...
import { font, leading, space, weight, shadow } from '@/lib/constants.stylex'
...
const NumberFieldScrubArea = ({
  ...
  style,
  ...props
}: Omit<React.ComponentProps<typeof NumberFieldPrimitive.ScrubArea>, 'className'> & {
  className?: string
}) => (
  <NumberFieldPrimitive.ScrubArea
    {...stylex.props(styles.scrub, customClassName(className), style as StyleXStyles)}
...
const NumberFieldIncrement = ({
  ...
  children,
  ...props
}: Omit<React.ComponentProps<typeof NumberFieldPrimitive.Increment>, 'className'> & {
  className?: string
}) => (
  <NumberFieldPrimitive.Increment
    {...stylex.props(styles.button, customClassName(className), style as StyleXStyles)}
...
const NumberFieldDecrement = ({
  ...
  children,
  ...props
}: Omit<React.ComponentProps<typeof NumberFieldPrimitive.Decrement>, 'className'> & {
  className?: string
}) => (
