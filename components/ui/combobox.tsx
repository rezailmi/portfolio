...
const Combobox = (props: React.ComponentProps<typeof ComboboxPrimitive.Root>) => (
...
const ComboboxItem = ({
  ...
  >
    {children}
    <ComboboxPrimitive.ItemIndicator className={stylex.props(styles.itemIndicator).className}>
      <CheckIcon size={16} />
