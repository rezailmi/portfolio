...
const BreadcrumbList = ({ className, style, ...props }: React.ComponentProps<'ol'>) => (
  <ol
...
const BreadcrumbItem = ({ className, style, ...props }: React.ComponentProps<'li'>) => (
  <li
...
const BreadcrumbPage = ({ className, style, ...props }: React.ComponentProps<'span'>) => (
  <span
    aria-current="page"
    {...stylex.props(styles.page, customClassName(className), style as StyleXStyles)}
...
const BreadcrumbEllipsis = ({ className, style, ...props }: React.ComponentProps<'span'>) => (
  <span
    aria-hidden="true"
    {...stylex.props(styles.ellipsis, customClassName(className), style as StyleXStyles)}
