...
import { font, leading, mq, space, shadow, weight } from '@/lib/constants.stylex'
...
const styles = stylex.create({
  ...
  sections: {
    ...
    gap: { default: space['6xl'], [mq.sm]: space['7xl'] },
  },
  section: {
    display: 'flex',
    flexDirection: 'column',
        ...
        <div {...stylex.props(styles.sections)}>
                        ...
                        <PopoverTrigger
                          render={
                            <button {...stylex.props(styles.swatchButton)}>
                              ...
                              />
                              <span {...stylex.props(styles.mutedXs, styles.swatchLabel)}>
                                {color.name}
                              </span>
                            </button>
                          }
          ...
          <Section title="Textarea" description="A multi-line text input">
            <Field.Root {...stylex.props(styles.stack2)}>
              ...
              <Field.Control render={<Textarea placeholder="Tell us a little about yourself" />} />
          ...
          <Section title="Field" description="Labeling and validation for form controls">
            <Field.Root {...stylex.props(styles.stack2)}>
              ...
              <Field.Control required render={<Input placeholder="Required" />} />
          ...
          <Section
            title="OTP Field"
            description="A one-time password input with one slot per character"
          >
            <OTPField length={6}>
          ...
          <Section title="Form" description="A native form with consolidated field errors">
            ...
            >
              <Field.Root name="url" {...stylex.props(styles.stack2)}>
                ...
                <Field.Control
                  render={
                    <Input defaultValue="https://example.com" placeholder="https://example.com" />
                  }
                />
                <Field.Error />
              </Field.Root>
